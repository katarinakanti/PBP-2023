...
function App() {
  return (
    <div className = "App">
      ...
      <section>
        <br/>
        <p className = "App-Isi"> DENGAN MEMOHON RIDHO DAN RAHMATMU IZINKAN KAMU BERSATU DALAM IKATAN SUCI PERNIKAHAN</p>
        ...
        <p className = "App-Isi">JALAN PIPOP KESAYANGAN BUNDA NO. 93 RT/RW 03/05, BULUSAN, SEMARANG, JAWA TENGAH 19051</p>
